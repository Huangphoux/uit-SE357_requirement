...
export const mockMaterials: Material[] = [
  {
    ...
    description:
      "Collection of 20 band 9 essays covering all common IELTS topics with detailed analysis",
    type: "pdf",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    description:
      "Comprehensive guide to all TOEIC listening question types with practice exercises",
    type: "pdf",
  },
  {
    id: "6",
  ...
  },
  {
    ...
    description:
      "Professional email writing guide with 50+ templates for various business situations",
    type: "pdf",
  },
  {
    id: "8",
...
export const mockAssignments: Assignment[] = [
  {
    ...
    description:
      'Write a 250-word essay: "Some people believe that environmental problems are too big for individuals to solve. To what extent do you agree or disagree?" Follow IELTS Task 2 format with clear introduction, body paragraphs, and conclusion.',
  ...
  },
  {
    ...
    description:
      'Record a 3-4 minute response to the topic card: "Describe a person who has influenced you." Then answer 3 Part 3 discussion questions. Upload your audio/video recording.',
  ...
  },
  {
    ...
    description:
      "Complete the full Academic Reading test (3 passages, 40 questions) within 60 minutes. Upload your answer sheet with all answers clearly marked.",
  ...
  },
  {
    ...
    description:
      "Submit your vocabulary journal with 50 new words learned this week. Include: word, definition, example sentence, and collocations. Use words from IELTS topics: Education, Technology, Health.",
  ...
  },
  {
    ...
    description:
      "Complete the 100-question TOEIC Listening section. Time limit: 45 minutes. Submit your answer sheet as PDF or image file.",
  ...
  },
  {
    ...
    description:
      "Complete all 100 questions from TOEIC Reading Part 5-7. Strict 75-minute time limit. Upload your completed answer sheet.",
  ...
  },
  {
    ...
    description:
      "Online quiz covering 50 common business vocabulary words and phrases frequently appearing in TOEIC tests.",
  ...
  },
  {
    ...
    description:
      "Prepare and record a 5-minute business presentation analyzing a company of your choice. Include: company overview, market position, challenges, and recommendations. Submit video or audio recording with PowerPoint slides.",
  ...
  },
  {
    ...
    description:
      "Write 3 professional emails: 1) Client complaint response, 2) Meeting invitation with agenda, 3) Follow-up after business meeting. Each email should be 150-200 words.",
  ...
  },
  {
    ...
    description:
      "Form a group of 3-4 students and record a 10-minute business meeting discussing a project proposal. Submit video recording showing all participants.",
